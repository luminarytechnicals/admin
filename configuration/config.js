const CONFIG = {
  site: {
    ...
    url: "https://luminarytechnicals.com",
  ...
  owner: {
    ...
    bio: "AR. Abhinav Ranjan is a self-driven developer, digital architect, and founder of Luminary Technicals — a personal tech ecosystem built to design, manage, and scale meaningful digital experiences. With expertise spanning full-stack development, hosting infrastructure, AI integration, and educational content, Abhinav brings ideas to life with precision and purpose.",
    message: "\"I didn't build Luminary Technicals to compete — I built it to create. Every division, every project, every line of code is a reflection of what I believe the digital world can be: structured, intentional, and luminous.\"",
  ...
  seo: {
    ...
    canonicalBase: "https://luminarytechnicals.com"
  },
  pwa: {
    enabled: true,
  ...
  organs: [
    { id:"servers", name:"Luminary Servers", icon:"🖥️", tagline:"Hosting & Infrastructure", description:"Enterprise-grade hosting, domain management, and cloud infrastructure solutions built for performance and reliability.", services:["Web Hosting","Domain Management","Cloud Infrastructure","SSL & Security","CDN Services"] },
    { id:"developers", name:"Luminary Developers", icon:"⚙️", tagline:"Web Dev & UI/UX", description:"Full-stack web development, responsive design, and modern UI/UX engineering for digital products that stand out.", services:["Full-Stack Development","UI/UX Design","PWA & Mobile Web","API Integration","Code Review"] },
    { id:"cares", name:"Luminary Cares", icon:"💛", tagline:"Support & Community", description:"Dedicated support, tech mentorship, and community-driven initiatives for those navigating the digital landscape.", services:["Tech Support","Mentorship","Community Events","Digital Literacy","Open Source Contributions"] },
    { id:"kits", name:"Luminary Kits", icon:"📦", tagline:"Project Kits & Collaborations", description:"Ready-made project kits, templates, and collaborative frameworks that accelerate development and creative workflows.", services:["Project Templates","Starter Kits","Collaboration Tools","Design Systems","Dev Toolkits"] }
  ],
  projects: [
  ...
  faqs: {
    general: [
      { q:"What is Luminary Technicals?", a:"Luminary Technicals is a personal tech ecosystem founded by Abhinav Ranjan that builds, manages, and scales digital projects and services across web development, hosting, AI, and tech education." },
      ...
      { q:"Is Luminary Technicals a registered company?", a:"Luminary Technicals is a personal tech ecosystem and brand. It operates as an independent digital entity managed by its founder, Abhinav Ranjan." },
      ...
      { q:"What does 'Build. Manage. Scale.' mean?", a:"It is the core philosophy of Luminary Technicals — build quality digital products, manage them with precision, and scale them for real-world impact." }
    ],
    projects: [
      ...
      { q:"Is the website open source?", a:"The Luminary Technicals website is self-built and proprietary. Some individual projects may be open-sourced — check the GitHub profile for available repositories." }
    ],
    collab: [
      { q:"How can I collaborate with Luminary Technicals?", a:"You can reach out via the Collab page or email luminarytechnicals@gmail.com. Collaborations are open for web projects, hosting partnerships, book publishing, AI work, and more." },
      { q:"What types of collaborations does Luminary accept?", a:"Luminary Technicals accepts collaborations across web development, hosting partnerships, book publishing, AI/automation projects, and tech education initiatives." },
      ...
      { q:"Can I submit a book to Luminary Books?", a:"Yes! Luminary Books accepts submissions for tech guides, tutorials, and educational content. Contact via email with your proposal and outline." }
    ],
    tech: [
      ...
      { q:"What kind of websites does Luminary Developers build?", a:"Luminary Developers specialises in full-stack web applications, responsive UI/UX, PWAs, API integrations, and performance-optimised digital products." },
    ...
    legal: [
      ...
      { q:"What data does Luminary Technicals collect?", a:"Luminary Technicals collects minimal data — only what is necessary for functionality and communication. Refer to the Privacy Policy for full details." },
      ...
      { q:"What are the terms of using the website?", a:"By using the Luminary Technicals website, you agree to the Terms of Service, covering acceptable use, intellectual property, and limitations of liability." },
